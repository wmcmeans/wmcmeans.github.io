...
/***/ function(module, exports, __webpack_require__) {
	...
	function toggleProfileView(e) {
	  ...
	  (0, _jquery2.default)('div.overlay').removeClass('inactive');
	  (0, _jquery2.default)('section.profile').removeClass('inactive');
	  (0, _jquery2.default)('main').addClass('inactive');
	
	  setTimeout(function () {
	    (0, _jquery2.default)('section.projects').addClass('inactive');
	    (0, _jquery2.default)('div.resume-link-container').addClass('sticky');
	  }, 1000);
	...
	function toggleProjectView(event) {
	  ...
	  function shiftLeft() {
	    ...
	    (0, _jquery2.default)('main').removeClass('inactive');
	
	    setTimeout(function () {
	      (0, _jquery2.default)('div.overlay').addClass('inactive');
	      (0, _jquery2.default)('section.profile').addClass('inactive');
	    }, 1000);
	  }
